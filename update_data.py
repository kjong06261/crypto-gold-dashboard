...
def get_data():
    ...
    <head>
        ...
        <style>
            ...
            .header {{ border-left: 4px solid #3b82f6; padding: 25px; margin: 40px 0; background: #0f172a; border-radius: 0 12px 12px 0; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); }}
            ...
            .footer {{ margin-top: 60px; text-align: center; color: #4b5563; font-size: 0.8rem; border-top: 1px solid #1e293b; padding: 40px 0; line-height: 1.6; }}
        </style>
    </head>
    <body>
        <div class="container">
            ...
            <div style="text-align:center; margin-bottom:30px; color:#1e293b; font-size:0.7rem;">ADVERTISEMENT</div>
    ...
    html += """
            ...
            <div class="footer">
                ...
                <p style="max-width:600px; margin: 10px auto;">Disclaimer: Financial data provided for informational purposes only. Not intended for trading purposes or advice.</p>
            </div>
        </div>
    </body>
    </html>
