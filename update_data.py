...
# Configuration
# =========================================================
# GitHub Pages가 /docs에서 빌드 중이면 무조건 ./docs로 저장해야 합니다.
...
# =========================================================
# ads.txt (AdSense 화면에 나온 "Ads.txt 스니펫" 라인으로 교체하세요)
# =========================================================
# 현재는 placeholder 입니다. AdSense에서 보여주는 라인을 그대로 여기에 넣으세요.
...
def generate_table(tickers: List[str], batch_data: pd.DataFrame) -> Tuple[str, Dict]:
    ...
    for symbol in tickers:
        ...
        def row_from_df(df_: pd.DataFrame) -> str:
            ...
            # Trend label (not action)
            if change > 0.5:
                marker, marker_color = "BULLISH", "#39d353"
            elif change < -0.5:
                marker, marker_color = "BEARISH", "#ff7b72"
            else:
                marker, marker_color = "NEUTRAL", "#888"
...
def main():
    ...
    # Git Push (optional - Actions에서 실행 시)
    try:
